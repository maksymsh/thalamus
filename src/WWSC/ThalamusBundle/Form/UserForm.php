    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('plainPassword', 'repeated', array(
                    ...
                    'first_options' => array('label' => false, 'attr' => array('class' => 'form-control', 'pattern' => '(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}', 'placeholder' => 'Password')),
                    'second_options' => array('label' => false, 'attr' => array('class' => 'form-control', 'pattern' => '(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}', 'placeholder' => 'Confirm password')),
